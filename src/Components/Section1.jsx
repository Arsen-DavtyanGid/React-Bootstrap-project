        ...
        <div className="row xxx">
          <div className="col-lg-12">
            <div className="section1-content">
              <div className="section1-text1">Photographer & Filmmaker</div>
              <div className="section1-text2">Aperture Studios</div>
              <div className="section1-text3-flex">
          ...
          <div className="col-lg-12">
            <div className="section1-icons">
              <div className="section1-icons-section">
                ...
                <div className="section1-icon-text">1/2000s</div>
              </div>
              <div className="section1-icons-section">
                <div className="section1-icon">
                  <svg
                ...
                <div className="section1-icon-text">f/11</div>
              </div>
              <div className="section1-icons-section">
                <div className="section1-icon">
                  <svg
              ...
              <div className="section1-icons-section">
                ...
                <div className="section1-icon-text">Iceland</div>
              </div>
            </div>
          </div>
        </div>
