        ...
        <div className="row">
          <div className="col-lg-6">
            <div className="section4-content">
              <div className="section4-text1">The Gear cage</div>
              <div className="section4-text2">The tools that we use.</div>
              <div className="section4-text3">
          ...
          <div className="col-lg-6 x">
            <div className="section4-rightpart">
              <div className="section1-icons">
                <div className="section1-icons-section">
                  ...
                  <div className="section1-icon">
                    ...
                    >
                      <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
                        d="M4.63925 10.5956L12.0234 14.8859C10.8401 15.597 9.46737 16 8 16C6.79297 16 5.65694 15.7393 4.63925 15.2415V10.5956ZM4.04733 6.39976V14.9331C1.82261 13.7005 0.284244 11.4012 0.0475711 8.72273L4.04733 6.39976ZM16 7.94027V8.01138C16 10.7136 14.651 13.1077 12.5919 14.5299L8.59215 12.2306L16 7.94027ZM11.9529 1.06667C14.1776 2.29926 15.716 4.59852 15.9527 7.27704L11.9529 9.6V1.06667ZM3.40808 1.46963L7.40785 3.76889L0 8.03556V8.01185C0 5.28593 1.34903 2.89185 3.40808 1.46963ZM8.00047 0C9.2075 0 10.3435 0.260741 11.3612 0.758519V5.38074L3.97704 1.09037C5.1604 0.402963 6.5331 0 8.00047 0Z"
                        fill="white"
                      />
                    </svg>
                  </div>
                  <div className="section1-icon-text">f/5,6</div>
                </div>
                <div className="section1-icons-section">
                  <div className="section1-icon">
                    <svg
